...
# Main chat endpoint.
# Protected by JWT through routers_chat.py.
app.include_router(
    routers_chat.router,
    prefix="/api",
)
...
app.include_router(
    routers_debug.router,
    prefix="/api",
)

# Standards and laboratory catalog endpoints.
app.include_router(
    routers_catalog.router,
    prefix="/api",
)

# User feedback endpoint.
app.include_router(
    routers_feedback.router,
    prefix="/api",
)
...
#
# These endpoints authenticate the user and make sure history
# is restricted to the authenticated user's own user_id.
app.include_router(
